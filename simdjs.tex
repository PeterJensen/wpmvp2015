...
code to achieve the desired performance, however, since there's no equivalent
way of expressing SIMD operations in JavaScript, the JavaScript code resulting from 
compiling the C/C++ applications is missing out on potentially significant performance
gains.
