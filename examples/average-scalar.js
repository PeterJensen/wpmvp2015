  ...
  if (($52 | 0) == 0) $nb$0 = $and144; else {
   ...
   if (($v$3$lcssa$i | 0) == 0) $nb$0 = $and144; else if ($rsize$3$lcssa$i >>> 0 < ((HEAP32[1004] | 0) - $and144 | 0) >>> 0) {
    ...
    L204 : do if ($rsize$3$lcssa$i >>> 0 < 16) {
     ...
     L224 : do if ((HEAP32[$88 + 4 >> 2] & -8 | 0) == ($rsize$3$lcssa$i | 0)) $T$0$lcssa$i = $88; else {
...
function _averageScalar($a, $length) {
 $a = $a | 0;
 $length = $length | 0;
 var $a$addr$06 = 0, $add = 0.0, $j$05 = 0, $sum$0$lcssa = 0.0, $sum$04 = 0.0, sp = 0;
 sp = STACKTOP;
 if (($length | 0) == 0) $sum$0$lcssa = 0.0; else {
  $a$addr$06 = $a;
  $j$05 = 0;
  $sum$04 = 0.0;
  while (1) {
