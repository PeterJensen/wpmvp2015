 ...
 if ((label | 0) == 202) {
  ...
  L311 : do if (($120 | 0) == 0) {
   ...
   if ((label | 0) == 224) if ((HEAP32[$sp$1105$i + 12 >> 2] & 8 | 0) == 0) {
    ...
    L348 : do if (($add$ptr16$i$i | 0) == (HEAP32[1008] | 0)) {
...
function _averageIntrin($a, $length) {
 $a = $a | 0;
 $length = $length | 0;
 var $add$i = SIMD_float32x4(0, 0, 0, 0), $j$09 = 0, $sumx4$0$lcssa = SIMD_float32x4(0, 0, 0, 0), $sumx4$010 = SIMD_float32x4(0, 0, 0, 0), sp = 0;
 sp = STACKTOP;
 if (($length | 0) == 0) $sumx4$0$lcssa = SIMD_float32x4_splat(Math_fround(0)); else {
  $j$09 = 0;
  $sumx4$010 = SIMD_float32x4_splat(Math_fround(0));
  while (1) {
   $add$i = SIMD_float32x4_add($sumx4$010, SIMD_float32x4_load(buffer, $a + ($j$09 << 2) | 0));
   $j$09 = $j$09 + 4 | 0;
   if (!($j$09 >>> 0 < $length >>> 0)) {
    $sumx4$0$lcssa = $add$i;
    break;
 ...
 STACKTOP = sp;
 return +((+$sumx4$0$lcssa.w + (+$sumx4$0$lcssa.z + (+$sumx4$0$lcssa.x + +$sumx4$0$lcssa.y))) / +($length >>> 0));
}
